...
if exist payload_4_78.bin     move  payload_4_78.bin     payload\payload_478C.bin>nul
if exist payload_4_78DEX.bin  move  payload_4_78DEX.bin  payload\payload_478D.bin>nul
if exist payload_4_80.bin     move  payload_4_80.bin     payload\payload_480C.bin>nul
if exist payload_4_80DEX.bin  move  payload_4_80DEX.bin  payload\payload_480D.bin>nul
:copy *.bin ..\datas\*
